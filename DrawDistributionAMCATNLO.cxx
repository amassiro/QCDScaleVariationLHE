...
void DrawDistributionAMCATNLO(std::string var = "jetpt1", int NBIN = 1000, int MIN = 0, int MAX = 1000, std::string varHR = ""){
 ...
 TFile* fCMS   = new TFile ("fAll_amcatnlo.root");
 ...
 toDraw = Form ("%s >> CMS",var.c_str());       tCMS    -> Draw(toDraw.Data(),"w11","goff");
 ...
 leg->AddEntry(h_e0_CMS,"CMS aMC@NLO","lp");
 leg->SetFillColor(0);
